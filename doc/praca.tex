...
\section{Wstęp}
Obecnie na rynku istnieją podobne systemy do tego, którego budowę ta praca przedstawia, jednak często kosztują tysiące złotych. Ta praca jest próbą stowrzenia rozwiązania spełniającego podobne zadanie do ww. systemów korzystając z ogólnie dostępnych podzespołów za nie wielkie pieniądze.
...
CoffeeScript jest językiem inspirowanym elegancką składnią Ruby i Pythona, który kompiluje się do JavaScriptu. Backbone.js natomiast zapewnia strukturę aplikacji wprowadzając model MVC.
\newline
\newline
\noindent
W momencie pisania kodu obu aplikacji nie wiedziałem jeszcze rzeczy, które wiem teraz zatem w kodzie znajdują się błędy - złe praktyki, których należy unikać. Postaram pokazać na czym one polegają i jakie trudności w późniejszym utrzymaniu kodu podowują, tak aby czytelnik był ich świadom i sam ich nie popełnił.
\newline
\newline
\noindent
...
Zadaniem slave-a - workera - jest jedynie pobranie czasu startu z Memcached, obliczenie czasu końcowego oraz wypisanie go na ekranie LCD linii końcowej w momencie finishu.
\begin{figure}
